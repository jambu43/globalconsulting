...
Route::get('/login/{lang?}', [AuthenticatedSessionController::class, 'showLoginForm'])
    ->middleware('guest')->name('login')->middleware(['XSS']);

Route::get('password/reset/lang/{lang?}', [AuthenticatedSessionController::class, 'showLinkRequestForm'])
    ->middleware('guest')->name('password.request2')->middleware(['XSS']);
