<?php if($customFields): ?>
    <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-lg-6">
            <div class="form-group mb-3 <?php echo e($customField->width); ?>">
                <label for="priority" class="form-label"><?php echo e(__($customField->name)); ?></label>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>
<?php /**PATH /Users/davidmalaba/Projects/TOT/globalconsulting/resources/views/admin/customFields/formBuilder.blade.php ENDPATH**/ ?>