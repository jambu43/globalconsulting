                ...
                <div class="col-xl-12 text-center">
                    ...
                    <div class="card">
                        <div class="card-body w-100">
                            ...
                            <form method="post" action="<?php echo e(route('home.store')); ?>" class="create-form" enctype="multipart/form-data" id="form-data">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-center">
                                        <div class="d-block ">
                                            ...
                                            <button class="btn btn-primary btn-block mt-2" id="ticket_button">
                                                <?php echo e(__('Create Ticket')); ?>
                        ...
                        <div class="chat_header btn-primary dark_background_color">
                            <div class="chat_option">
                                <div class="header_img">
                                    <img src="<?php echo e($logos.'logo-light.png' .'?'.time()); ?>" />
                                </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/davidmalaba/Projects/TOT/globalconsulting/resources/views/home.blade.php ENDPATH**/ ?>