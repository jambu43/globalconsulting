                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3 switch-width">
                                                        <div class="form-group mr-3">
                                                            <label class="form-label"><?php echo e(__('Knowledge Base')); ?></label>
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox" data-toggle="switchbutton"
                                                    ...
                                                    <div class="col-lg-4 col-xl-4 col-md-4">
                                                        ...
                                                        <div class="form-check form-switch mt-2 ">
                                                            ...
                                                            <input type="checkbox" class="form-check-input"
                                                                ...
                                                                <?php echo e($cust_theme_bg == 'on' ? 'checked' : ''); ?> />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail Driver')); ?>"
                                            ...
                                            value="<?php echo e(!isset($setting['mail_driver']) || is_null($setting['mail_driver']) ? '' : $setting['mail_driver']); ?>"
                                            id="mail_driver">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail Host')); ?>" name="mail_host"
                                            type="text"
                                            value="<?php echo e(!isset($setting['mail_host']) || is_null($setting['mail_host']) ? '' : $setting['mail_host']); ?>"
                                            id="mail_host">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail Port')); ?>" name="mail_port"
                                            type="text"
                                            value="<?php echo e(!isset($setting['mail_port']) || is_null($setting['mail_port']) ? '' : $setting['mail_port']); ?>"
                                            id="mail_port">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail Username')); ?>"
                                            ...
                                            value="<?php echo e(!isset($setting['mail_username']) || is_null($setting['mail_username']) ? '' : $setting['mail_username']); ?>"
                                            id="mail_username">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail Password')); ?>"
                                            ...
                                            value="<?php echo e(!isset($setting['mail_password']) || is_null($setting['mail_password']) ? '' : $setting['mail_password']); ?>"
                                            id="mail_password">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail Encryption')); ?>"
                                            ...
                                            value="<?php echo e(!isset($setting['mail_encryption']) || is_null($setting['mail_encryption']) ? '' : $setting['mail_encryption']); ?>"
                                            id="mail_encryption">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail From Address')); ?>"
                                            ...
                                            value="<?php echo e(!isset($setting['mail_from_address']) || is_null($setting['mail_from_address']) ? '' : $setting['mail_from_address']); ?>"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Mail From Name')); ?>"
                                            ...
                                            value="<?php echo e(!isset($setting['mail_from_name']) || is_null($setting['mail_from_name']) ? '' : $setting['mail_from_name']); ?>"
                                            id="mail_from_name">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="pusher-settings" class="card">
                        <form method="POST" action="<?php echo e(route('admin.pusher.settings.store')); ?>"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary"
                                            ...
                                            <?php echo e(Utility::settings()['RECAPTCHA_MODULE'] == 'yes' ? 'checked="checked"' : ''); ?>>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                        ...
                                        <input class="form-control" placeholder="<?php echo e(__('Enter Google Recaptcha Key')); ?>"
                                            ...
                                            value="<?php echo e(!empty($setting['NOCAPTCHA_SITEKEY']) ? $setting['NOCAPTCHA_SITEKEY'] : ''); ?>"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                        ...
                                        <input class="form-control "
                                            ...
                                            value="<?php echo e(!empty($setting['NOCAPTCHA_SECRET']) ? $setting['NOCAPTCHA_SECRET'] : ''); ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('company_name', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('company_address', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('company_city', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('company_state', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('company_zipcode', null, ['class' => 'form-control', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('company_country', null, ['class' => 'form-control ', 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php echo e(Form::text('company_telephone', null, ['class' => 'form-control', 'required' => 'required'])); ?>
                                    ...
                                    <div class="form-group col-md-6 mt-2">
                                        ...
                                        <select name="timezone" id="timezone" class="form-control custom-select"
                                            ...
                                            <?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $timezone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if(App\Models\Utility::getSettingValByName('timezone') == $k): ?> selected <?php endif; ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php echo e(Form::text('chatgpt_key', isset($setting['chatgpt_key']) ? $setting['chatgpt_key'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Chatgpt Key Here'), 'required' => 'required'])); ?>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php echo e(Form::text('chat_gpt_model', isset($setting['chat_gpt_model']) ? $setting['chat_gpt_model'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Chat GPT Modal Name'), 'required' => 'required'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/main-file/resources/views/admin/users/setting.blade.php ENDPATH**/ ?>