                    ...
                    <div class="chat-wrap">
                                        ...
                                        <li class="user_chat" id="<?php echo e($user->id); ?>">
                                            <div class="peroson">
                                                <img class="avatar-sm rounded-circle mr-3" style="width:40px;"
                                                    src="<?php echo e(!empty($avtar->avatar) ? $logo . $avtar->avatar : $logo . 'avatar.png'); ?>" alt="<?php echo e($user->email); ?>">

                                                <div class="agent-div w-100">
                                                    <?php if(!empty($user->name)): ?>
                                                        <h6 class="m-0 chat_user"><?php echo e($user->name); ?>

                                                        </h6>
                                                        <span class="text-muted text-small"><?php echo e($user->email); ?></span>
                                                    <?php else: ?>
                                                        <h6 class="m-0 ">
                                                            <span class="chat_users" style="font-size: 14px; line-height: 14px; color: #606679;"> <?php echo e($user->email); ?></span>
                            ...
                            <div class="chat-head">
                                <div class="peroson">
                                    <div class="float-left">
                                        ...
                                        <img class="avatar-sm rounded-circle mr-3" style="width:40px;"
                                            src="<?php echo e(asset(Storage::url('avatar.png'))); ?>"
                                            alt="agent2@example.com">
                                        <h6 class="m-0 chat_head"><?php echo e(__('Please Select User')); ?></h6>
                                    </div>
                                    <div class="float-right">
                                        <a href="#" id="image" class="add-to-favorite favorite"
                                            style="display: inline; color: #606679;"><i id="foo"
                                                class="fa fa-star"></i></a>
                                        <a href="#" class="show-infoSide header-icon" style="color: #6FD943;">
                            ...
                            <div class="chat-footer" style="display: none;">
                                <div class="send-msg-box">
                                    ...
                                    <input type="text" class="form-control send_msg"
                                        placeholder="<?php echo e(__('Type Message here ')); ?>" name="message" /><i
                        ...
                        <div class="messenger-infoView">
                            ...
                            <img class="avatar-sm rounded-circle mr-3"
                                ...
                                alt="agent2@example.com">
                                <p class="info-name chat_head"><?php echo e(!empty($user->email) ? $user->email : 'Messenger'); ?></p>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var pusher = new Pusher('<?php echo e($setting['PUSHER_APP_KEY']); ?>', {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/main-file/resources/views/admin/chats/index.blade.php ENDPATH**/ ?>