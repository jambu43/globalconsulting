...
// $LangName = App\Models\Languages::where('code',$curr_noti_tempLang->lang)->first();
...
<div class="text-end mb-3">
    <div class="d-flex justify-content-end drp-languages">
            ...
            <li class="dropdown dash-h-item drp-language" style="list-style-type: none;">
                ...
                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                    ...
                    <a href="<?php echo e(route('notification-templates.index', [$notification_template->id, $code])); ?>"
                        class="dropdown-item <?php echo e($curr_noti_tempLang->lang == $code ? 'text-primary' : ''); ?>"><?php echo e(ucFirst($lang)); ?></a>
        ...
        <ul class="list-unstyled mb-0 m-2">
            <li class="dropdown dash-h-item drp-language" style="list-style-type: none;">
                <a class="btn btn-primary btn-sm float-end" style="height:35px; margin-top:3px;" href="#" data-size="md" data-ajax-popup-over="true" data-url="<?php echo e(route('generate',['notification template'])); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Generate')); ?>" data-title="<?php echo e(__('Generate Content with AI')); ?>"><i class="fas fa-robot"> <?php echo e(__('Generate with AI')); ?></i></a>
            </li>
        </ul>
        <?php endif; ?>
    </div>
                    ...
                    <?php echo e(Form::model($curr_noti_tempLang,array('route' => array('notification-templates.update', $curr_noti_tempLang->parent_id), 'method' => 'PUT'))); ?>
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <?php echo e(Form::textarea('content',$curr_noti_tempLang->content,array('class'=>'form-control','required'=>'required','rows'=>'3','placeholder'=>'EX. Hello, {company_name}'))); ?>

                                <small><?php echo e(__('A variable is to be used in such a way.')); ?> <span class="text-primary"><?php echo e(__('Ex. Hello, {company_name}')); ?></span></small>
                            </div>
                        </div>
                        <hr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/main-file/resources/views/notification_templates/index.blade.php ENDPATH**/ ?>